...
public class UserInfoDTOTest {
	...
	//getSex test(1～5)----------------------------------
		...
		public void testGetSex4()throws Exception{
			UserInfoDTO dto=new UserInfoDTO();
			try{
				int postalMax=2147483647;
				dto.setSex(postalMax+1);
			}catch(RuntimeException e){
