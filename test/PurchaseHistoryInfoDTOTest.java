...
import com.internousdev.mars.dto.PurchaseHistoryInfoDTO;
...
public class PurchaseHistoryInfoDTOTest {
	...
	@Test
	public void testGetProductCategoryId1() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = 0;
	...
	@Test
	public void testSetProductCategoryId1() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = 0;
		dto.setCategoryId(expected);
	...
	@Test
	public void testGetProductCategoryId2() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = max;
		dto.setCategoryId(expected);
	...
	@Test
	public void testSetProductCategoryId2() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = max;
		dto.setCategoryId(expected);
	...
	@Test
	public void testGetProductCategoryId3() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = min;
		dto.setCategoryId(expected);
	...
	@Test
	public void testSetProductCategoryId3() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		int expected = min;
		dto.setCategoryId(expected);
